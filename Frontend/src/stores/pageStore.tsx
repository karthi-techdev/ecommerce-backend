...
//   addPages: (formData: FormData) => Promise<Page | null>;
//   updatePages: (id: string, formData: FormData) => Promise<Page | null>;
...
//         `${API.listPage}?page=${page}&limit=${limit}${
...
//   addPages: async (formData: FormData) => {
//     try {
...
//   updatePages: async (id: string, formData: FormData) => {
//     try {
...
//     try {
//       await axiosInstance.delete(`${API.hardDeletePage}${id}`);
...
//     } catch (error: any) {
//       set({
//         error: error?.response?.data?.message || "Failed to hard delete Page",
//       });
//       throw error;
//     }
//   },
...
//     try {
//       const res = await axiosInstance.put(API.checkDuplicatePage, {
//         slug,
